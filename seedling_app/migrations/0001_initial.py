...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='belonging_mfys',
            field=models.ManyToManyField(related_name='inspectors', to='seedling_app.mahalla'),
        ),
        migrations.CreateModel(
            name='Photos',
            fields=[
                ...
                ('photo_type', models.CharField(choices=[('PASSPORT', 'Passport Photo'), ('CONTRACT', 'Contract Document'), ('SEEDLING', 'Seedling Photo'), ('EVENT', 'Event Photo')], db_index=True, max_length=20)),
                ...
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='photos', to='contenttypes.contenttype')),
            ],
            options={
                'verbose_name': 'Photo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('type', models.CharField(choices=[('APPLE', 'Apple'), ('PEAR', 'Pear'), ('CHERRY', 'Cherry'), ('APRICOT', 'Apricot')], db_index=True, max_length=20)),
                ('location', models.CharField(help_text='GPS coordinates or location description', max_length=255)),
                ('plant_status', models.CharField(choices=[('PLANTED', 'Planted'), ('GROWING', 'Growing'), ('MATURE', 'Mature'), ('HARVESTED', 'Harvested'), ('DAMAGED', 'Damaged')], db_index=True, default='PLANTED', max_length=20)),
                ('plant_date', models.DateField(auto_now_add=True)),
                ('comment', models.TextField(blank=True)),
                ('foto', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='seedling_photos', to='seedling_app.photos')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(auto_now_add=True)),
                ('comment', models.TextField(blank=True)),
                ('foto', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='event_photos', to='seedling_app.photos')),
                ('parent_seedling', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='agro_events', to='seedling_app.seedling')),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='customuser',
            index=models.Index(fields=['phone'], name='CustomUser_phone_057fae_idx'),
        ),
        migrations.AddIndex(
            model_name='customuser',
            index=models.Index(fields=['username'], name='CustomUser_usernam_57bb3f_idx'),
        ),
        migrations.AddIndex(
            model_name='photos',
            index=models.Index(fields=['photo_type'], name='Photos_photo_t_ae7d38_idx'),
        ),
        migrations.AddIndex(
            model_name='photos',
            index=models.Index(fields=['content_type', 'object_id'], name='Photos_content_82d588_idx'),
        ),
        migrations.AddIndex(
            model_name='district',
        ...
        migrations.AddIndex(
            model_name='seedling',
            index=models.Index(fields=['type'], name='Seedling_type_fa506d_idx'),
        ),
        migrations.AddIndex(
            model_name='seedling',
            index=models.Index(fields=['plant_status'], name='Seedling_plant_s_983e22_idx'),
        ),
        migrations.AddIndex(
            model_name='seedling',
